(function(){
  ...
  xfc = function(opt){
    ...
    if (this.upload && (typeof ldFile != 'undefined' && ldFile !== null)) {
      ...
      this.ldf.on('load', function(it){
        ...
        ret = filename.split('-');
        ref$ = in$(ret[ret.length - 1], xfc.variants)
  ...
  xfc.variants = ['Italic', 'Regular', 'Bold', 'ExtraBold', 'Medium', 'SemiBold', 'ExtraLight', 'Light', 'Thin', 'Black', 'BlackItalic', 'BoldItalic', 'ExtraBoldItalic', 'MediumItalic', 'LightItalic', 'ThinItalic', 'SemiBoldItalic', 'ExtraLightItalic', 'DemiBold', 'Heavy', 'UltraLight'];
  xfc.prototype = import$(Object.create(Object.prototype), {
    ...
    load: function(font){
      ...
      return new Promise(function(res, rej){
        var opt, path, name, list, ref$, variant;
        opt = {};
        if (font.path) {
          opt.ext = font.ext;
          opt.name = font.name;
          ...
          if (~font.name.indexOf('-')) {
            ...
            if (list.length > 1 && in$(list[list.length - 1], xfc.variants)) {
